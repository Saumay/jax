...
def key_impl(keys: ArrayLike) -> str | PRNGSpec:
  warnings.warn(
      "jax.random.key_impl is deprecated as of JAX v0.10.1 and will be"
      " removed in a future release. Use arr.dtype in place of the"
      " impl string starting in this version.",
      DeprecationWarning,
      stacklevel=2)
